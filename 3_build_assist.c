...
/**
 * help_cd - Displays information on shellby builtin command 'cd'.
 */
void help_cd(void)
{
...
/**
 * help_exit - Displays information on shellby builtin command 'exit'.
 */
void help_exit(void)
{
...
/**
 * help_help - Displays information on shellby builtin command 'help'.
 */
void help_help(void)
{
